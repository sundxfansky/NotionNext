...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '愿你仍是少年', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.sdxx.de', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Tonser, 博客', // 网站关键词 英文逗号隔开
